...
$(document).ready(function () {
  $('.menu__btn').click(function () {
    ...
    $('body').addClass('overflow-hidden bg-hide');
    $('html').addClass('overflow-hidden'); // $('body').addClass('');
...
//   console.log('test anim scroll');
//   clearTimeout($.data(this, 'scrollTimer'));
//   var wi = $(window).width();
//       if (wi < 991) {
//           var heaedrSlide = $('.menu__btn');
//           $.data(this, 'scrollTimer', setTimeout(function() {
//               heaedrSlide.removeClass('_active');
//               setTimeout(function () {
//                   console.log('test anim');
//                   heaedrSlide.addClass('_active');
//               }, 500);
//           }, 500));
//       }
// });
...
$(window).scroll(function () {
  ...
  if (scrollTop > lastScrollTop && winW < 991) {
    heaedrSlide.removeClass('_active');
  } else {
    heaedrSlide.addClass('_active');
  }
